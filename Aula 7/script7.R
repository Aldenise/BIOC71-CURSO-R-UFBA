...
### o pull mostra os dados que estão sendo carregados e alterados. O push envia para o github as mudancas.
#O que é um pull request?
### Saõ comentarios para outras pesssoas das mudanças foram feitas.

#O que é um fork?
###É uma cópia do arquivo, para qeu você possa modificar e não alterar o arquivo original.
